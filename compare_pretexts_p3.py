...
RESULTS_DIR = "/Users/martu/Desktop/machine_project/RESULTS_DEFINITIVO"
...
class ChestXrayDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Convert (1, H, W) → (3, H, W) for ResNetimg = img.repeat(3, 1, 1)
...
# FUNCTIONS TO LOAD PRETEXT ENCODERS

def modify_resnet_for_grayscale(model):
    # change 1st to accept gray images (1 channel) 
...
# FINE-TUNING FOR A SINGLE ENCODER
...
# EMBEDDING SPACE ANALYSIS (t-SNE, Silhouette, Davies-Bouldin)
...
# RUN EXPERIMENTS FOR MULTIPLE ENCODERS
if __name__ == "__main__":
    ...
    for enc_name, enc_path in pt3_encoders:
    ...
    analyze_embeddings_for_all_encoders(pt3_encoders)
    ...
    print("Experimentos de pretextos y análisis de embeddings completos solo para PT3.")
